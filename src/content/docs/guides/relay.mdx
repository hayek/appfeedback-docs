...
<Aside type="tip">`@appfeedback/relay` is framework-agnostic. The same `handleFeedback` runs behind a Cloudflare Worker, a Vercel/Netlify function, Firebase, Appwrite, or your own server.</Aside>
